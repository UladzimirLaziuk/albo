"""
Django settings for albo project.
...
WSGI_APPLICATION = 'albo.wsgi.application'
...
EXPORT_FTP_ADDRESS = os.environ.get('EXPORT_FTP_ADDRESS')
FILE_NAME_FOR_EXPORT = os.environ.get('FILE_NAME_FOR_EXPORT')
